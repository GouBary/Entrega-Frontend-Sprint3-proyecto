...
export const searchEjercisioASync=(nombre)=>{
    return async(dispatch)=>{
       const collectionAListar = collection(DB, "Ejercisios")
...
export const listaEjercisiosASync = () =>{
    return async (dispatch) =>{
       const collectionListar = await  getDocs(collection(DB,"Ejercisios"))
...
export const addEjercisioASync =(Ejercisio) =>{
     return async (dispatch)=>{
        addDoc(collection(DB,"Ejercisios"),Ejercisio)
